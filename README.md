...
Для составления конспекта студенты разделятся на группы из 6 или 7 человек,
каждая группа возьмет на себя ответственность составления подробного, полноценного
конспекта одной из 14 лекций курса. Эта работа должна быть сдана лектору не позже
чем четыре дня после лекции.

**Оценика за курс**: если ваш итоговый балл равен _x_ (от 0 до 100), то:
...
**Но имеете ввиду, что в силу плотности так и ващей как и нашей занятости, сдача будет 
...
Э-почта — предпочитаемый мной канал общения. Смартфонными приложениями
...
Так называемый "искусственный интеллект" в этом предмете вам 
ни чем не поможет. Вы должны будете самостоятельно думать 
и пользоваться умением читать **тексты**. Чем больше вы будете
пользоваться ИИ, тем хуже будет для вас. Он не будет рядом с
...
1. 29 августа: введение в курс. Наивная вероятность, задачи. Модели вероятности с конечным числом исходов, задачи. Условные вероятности.
2. 5 сентября: условные вероятности, независимость, формула Байеса, схема Бернулли и случайные графы.
3. 8 сентября: 
4. 15 сентября:
6. 22 сентября: 
7. <ins>29 сентября</ins>: **первая контрольная работа** *во время наставления* по темам 1–6. Лекционное время отводится на разбор задач.
8. 6 октября: 
9. 13 октября: 
10. 20 октября: 
11. 27 октября: 
13. 10 ноября: 
14. <ins>17 ноября</ins>: **вторая контрольная работа** *во время наставления* по темам 9–14. Лекционное время отводится на разбор задач.
15. 24 ноября: 
17. 1 декабря:
18. 8 декабря:
